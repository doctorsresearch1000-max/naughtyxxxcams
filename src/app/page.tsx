...
export default function HomePage() {
  ...
  return (
    <>
      <main
        className="pointer-events-none relative mx-auto w-full max-w-md overflow-hidden bg-black text-white"
      ...
      >
        ...
        <section className="pointer-events-none relative h-full w-full overflow-hidden touch-pan-y">
          <CrackWidget
            cols={1}
            rows={1}
            number={15}
      ...
      <SoundUnlockPortal visible={isMuted} onUnlock={unlockSound} />
    </>
  );
}
