...
export default function HomePage() {
  ...
  const unlockSound = useCallback((e: React.SyntheticEvent) => {
    e.preventDefault();
    e.stopPropagation();
    setIsMuted(false);
  }, []);
  ...
  return (
    <main className="relative mx-auto flex h-[100dvh] w-full max-w-md flex-col overflow-hidden bg-black text-white">
      ...
      {/* Zona del feed: altura fija por encima del BottomNav (4rem) */}
      <section
      ...
      >
        ...
        {/* Capa UI decorativa: no intercepta toques */}
          ...
          {isMuted && (
            <div className="flex h-full items-center justify-center">
              <button
                type="button"
                onClick={unlockSound}
                onTouchEnd={unlockSound}
                className="pointer-events-auto z-50 cursor-pointer touch-manipulation transition-transform active:scale-95"
        ...
        {/* Acciones laterales: únicos elementos táctiles extra (además del iframe) */}
